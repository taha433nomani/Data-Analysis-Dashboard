# Walmart-Store-Data-Analysis (Interactive Dashboard creation using MS Excel)
## Project Objective
The Walmart Store wants to create an annual sales report for 2022. So that, the owner of the Vrinda store can understand their customers and grow more sales in 2023 & 2024.

## Dataset used
- <a href="https://github.com/taha433nomani/Data-Analysis-Dashboard/blob/main/Sales_Performance_Analysis_Project.xlsx">Dataset</a>
...
## Dashboard
<img width="1034" height="538" alt="Sales_Dashboard" src="https://github.com/user-attachments/assets/1edbca06-3338-4715-be4d-83f17cf99107" />
...
Q3 and Q2 show marginally higher performance compared to Q1 and Q4.
 The business demonstrates consistent quarterly performance without extreme volatility.
## Final Conclusion:
The Sales Performance Analysis Dashboard provides clear, data-driven insights into the company’s overall performance.
The analysis reveals that the Consumer segment is the primary revenue contributor, with the North region generating the highest sales. Among product categories, Furniture emerges as the top-performing category, followed by Electronics and Office Supplies. Additionally, quarterly sales trends indicate stable and consistent business performance without significant fluctuations.
Based on these insights, the company should focus on strengthening its presence in high-performing regions and customer segments while promoting best-selling product categories. Enhancing digital marketing efforts, optimizing high-revenue sales channels, and maintaining strong operational efficiency will further support sustained revenue growth.
Overall, this project demonstrates how Excel-based data analysis and dashboard visualization can transform raw sales data into actionable business strategies for informed decision-making.
